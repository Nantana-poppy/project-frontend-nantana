  ...
  return (
    <>
      ...
      <div className="px-8 py-8">
        ...
        <div className="mx-auto max-w-7xl p-3 bg-slate-50/90 rounded-4xl shadow-lg">
          {/* Category */}
          <p className="text-3xl px-10 pb-5 font-semibold text-[#0f4c81]">
            Category Trips
          </p>
          ...
          {/* Freatured Trips  */}
          <div>
            <p className="text-3xl px-10 pt-8 font-semibold text-[#0f4c81]">
              Explore Trips
            </p>
