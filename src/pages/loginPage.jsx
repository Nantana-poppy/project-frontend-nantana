...
export function LogInContent() {
  ...
  const handleSocialClick = (provider) => {
    toast.info(`Sign in with ${provider} will be available soon`);
  };

  return (
    <div className="min-h-screen w-full bg-white flex flex-col lg:flex-row items-stretch">
      {/* Left side: Form */}
      <div className="w-full lg:w-1/2 flex items-center justify-center px-6 py-12 sm:px-12 md:px-16 lg:px-20">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="flex items-center gap-2 pt-1">
              <input
                ...
                className="h-4 w-4 rounded border-gray-300 text-[#385526] focus:ring-[#385526] cursor-pointer accent-[#385526]"
              />
              <label
                htmlFor="remember"
